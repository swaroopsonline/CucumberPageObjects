...
public class RunCuke extends AbstractTestNGCucumberTests{
    ...
    public static void setup() {
        ...
        ExtentCucumberFormatter.addSystemInfo("Browser version", "v75.0.3770.142");
        ExtentCucumberFormatter.addSystemInfo("Selenium version", "v3.141.5");
